...
{
    Serial.begin(115200);
    Serial1.begin(9600); // เพิ่มสำหรับ UART
    delay(500);
...
void loop()
{
    ...
    */
    ...
    Serial1.print(filteredAltitude); Serial1.print(",");
    Serial1.print(filteredPitchRate, 2); Serial1.print(",");
    Serial1.print(filteredYawRate, 2); Serial1.print(",");
    Serial1.print(pos1); Serial1.print(",");
    Serial1.print(pos2); Serial1.print(",");
    Serial1.print(pos3); Serial1.print(",");
    Serial1.println(pos4);
